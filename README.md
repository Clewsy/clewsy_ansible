...
The [flexo.yml][link_repo_flexo] playbook is a special case.  It will configure my smartphone via [Termux][link_web_termux] and as such, has some additional pre-requisites:
